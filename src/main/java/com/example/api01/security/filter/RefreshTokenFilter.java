...
public class RefreshTokenFilter extends OncePerRequestFilter {
    ...
    private void sendTokens(String accessATokenValue, String refreshTokenValue, HttpServletResponse response) {
        response.setContentType(MediaType.APPLICATION_JSON_VALUE);

        Gson gson = new Gson();
        String jsonStr = gson.toJson(Map.of("accessToken", accessATokenValue, "refreshToken",refreshTokenValue));
